...
handler({
  ...
  configSecretSourceId: 'arn:aws:secretsmanager:ca-central-1:687384172140:secret:accelerator/config/in-progress-XiXqsv',
  stackOutputSecretId: 'arn:aws:secretsmanager:ca-central-1:687384172140:secret:accelerator/outputs-Eqgcx5',
  accounts: [
    {
      key: 'shared-network',
      id: '007307298200',
