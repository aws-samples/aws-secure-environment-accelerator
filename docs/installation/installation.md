...
- [3. Upgrades](#3-upgrades)
  - [3.1. Summary of Upgrade Steps (all versions)](#31-summary-of-upgrade-steps-all-versions)
- [4. Notes](#4-notes)
  - [4.1. Configuration File Hints and Tips](#41-configuration-file-hints-and-tips)
  - [4.2. Considerations: Importing existing AWS Accounts / Deploying Into Existing AWS Organizations](#42-considerations-importing-existing-aws-accounts--deploying-into-existing-aws-organizations)
    - [4.2.1. Process to import existing AWS accounts into an Accelerator managed Organization](#421-process-to-import-existing-aws-accounts-into-an-accelerator-managed-organization)
    - [4.2.2. Deploying the Accelerator into an existing Organization](#422-deploying-the-accelerator-into-an-existing-organization)
  - [4.3. Design Constraints / Decisions](#43-design-constraints--decisions)
- [5. AWS Internal - Accelerator Release Process](#5-aws-internal---accelerator-release-process)
  - [5.1. Creating a new Accelerator Code Release](#51-creating-a-new-accelerator-code-release)
...
## 3.1. Summary of Upgrade Steps (all versions)
...
## 4.1. Configuration File Hints and Tips
...
## 4.2. Considerations: Importing existing AWS Accounts / Deploying Into Existing AWS Organizations
...
### 4.2.1. Process to import existing AWS accounts into an Accelerator managed Organization
...
### 4.2.2. Deploying the Accelerator into an existing Organization
...
# 5. AWS Internal - Accelerator Release Process

## 5.1. Creating a new Accelerator Code Release
