...
translate(c.SubnetDefinitionConfig, {
  ...
  fields: {
    ...
    cidr: {
      title: 'CIDR-NOT USED',
      description: 'IS THIS FIELD STILL USED???',
    },
    'route-table': {
      title: '',
    ...
    disabled: {
      ...
      description: 'Define the subnet in the Accelerator, but do not actually create it',
    },
  },
});
...
translate(c.MandatoryAccountConfigType, {
  ...
  fields: {
    'account-name': {
      title: '',
      description: 'Provide a name for this account that will be referenced throughout the rest of the configuration',
    },
    description: {
      title: 'Description',
      description: '',
