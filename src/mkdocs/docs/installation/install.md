...
15. If the state machine **fails**:
    ...
    - Refer to the [Troubleshooting Guide](../operations/index.md#4-troubleshooting) for instructions on how to inspect and retrieve the error
    - You can also refer to the [FAQ](../faq/index.md) and [Known Installation Issues](#251-known-installation-issues)
